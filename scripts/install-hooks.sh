...
# spec/sdlc's tie -- alloy-check, whose --staged compares the index's
...
# runs: check-rule-readers.py check-tree-shape.py check-cross-references.py check-sdlc-tie.py check-suite-witness.py check-cited-claims.py check-model-comment.py alloy-check.py check-commit-claim.py
set -e
